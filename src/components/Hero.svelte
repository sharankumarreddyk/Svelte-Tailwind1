...
<SectionWrapper>
    ...
    >
        <h2
            class="text-5xl sm:text-6xl md:text-7xl text-base-200 lg:text-8xl max-w-[1200px] mx-auto w-full text-center font-semibold"
        >
        ...
        <p
            class="text-xl sm:text-2xl md:text-3xl text-base-200 text-center max-w-[1000px] mx-auto w-full"
        >
